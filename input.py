...
class DataGetter():
    ...
    def make_datasets(self):
        self.image_dataset = CustomDataSet(main_dir, self.curr_index, self.batch_size)
        self.train_loader = DataLoader(self.image_dataset , batch_size=batch_size, shuffle=False)
        self.train_loader_iterator = iter(self.train_loader)

        self.pos_dataset = PositioningDataset(main_dir, self.curr_index, self.batch_size)
        self.pos_loader = DataLoader(self.pos_dataset , batch_size=batch_size, shuffle=False)
...
batch_size = 64
all_data = DataGetter(main_dir, batch_size)
i = 0
